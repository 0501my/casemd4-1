export declare class HtmlController {
    ...
    static applewatch(req: any, res: any, next: any): Promise<void>;
    static airpods(req: any, res: any, next: any): Promise<void>;
    static allproducts(req: any, res: any, next: any): Promise<void>;
}
